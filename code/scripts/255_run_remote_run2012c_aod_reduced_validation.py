...
OUT = ROOT / "outputs_run2012c_aod_reduced_validation"
TABLES = OUT / "tables"
...
FILES_PER_STREAM = 3
VALIDATION_ID = "Run2012C_AOD_reduced_cross_era"
...
def run_stream(row: dict[str, object]) -> dict[str, object]:
    ...
    run_id = f"remote_run2012c_aod_{primary.lower()}_reduced"
    ...
    return {
        ...
        "feature_scope": "reduced_AOD_OPQ; no MiniAOD packed candidates or secondary vertices",
    }
...
def main() -> None:
    ...
    ledger.to_csv(TABLES / "01_run2012c_aod_reduced_extraction_ledger.csv", index=False)
    print(TABLES / "01_run2012c_aod_reduced_extraction_ledger.csv")
